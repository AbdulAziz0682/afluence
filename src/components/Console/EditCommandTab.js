...
import {Grid, Button, Typography, IconButton, InputBase, TableContainer, Table, TableHead, TableRow, TableCell, TableBody} from '@material-ui/core';
        ...
        <Grid container direction="column" className="border rounded-lg overflow-scroll sm:overflow-auto bg-white h-full">
            <Grid item className="gap-3 p-2 sm:p-3 border-b items-center justify-between flex flex-col md:flex-row">
                ...
                <div className="flex gap-9 md:justify-end w-full md:w-5/12 items-center justify-between">
                    <Button variant="contained" color="secondary" className="md:w-36">Delete</Button>
            ...
            <Grid item className="p-2 sm:p-3 w-full">
                <Grid container direction="column">
                    <Grid item className="flex flex-col w-full">
                        <Typography className="text-2xl font-bold md:text-4xl">Add sample Phrases</Typography>
                        <Typography>Upload sample audio phrases that a user might say to match this command.</Typography>
                    </Grid>
                                            ...
                                            <TableRow>
                                                ...
                                                <TableCell className="px-0.5 md:px-3 my-1 border-b-0">
                                                    ...
                                                    <div className="rounded-sm bg-gray-100 px-1 w-30 md:w-11/12 xl:w-9/12 md:flex-row h-9 flex flex-col justify-between items-center">
                                                        <span className="overflow-auto h-full w-full px-2 text-xs flex items-center">{ file ? file.name : "No file chosen"}</span>
                                                        <label htmlFor="upload-audio" className="bg-white rounded-lg text-xs px-1 w-24 md:w-28 text-center">Choose file</label>
                                                    </div>
                                                </TableCell>
                                                <TableCell className="px-0.5 md:px-3 my-1 border-b-0">
                                                    <InputBase 
