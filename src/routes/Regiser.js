                                ...
                                <Grid container alignItems="center" direction="column" className="my-6">
                                    ...
                                    <Grid item className="w-full my-1">
                                        <TextField
                                            ...
                                            InputProps={{
                                                startAdornment:(
                                                    <InputAdornment postition="start">
                                                        <img src={companyicon} style={{maxWidth: inputIconSize, minHeight: inputIconSize}} alt="company" />
                                                    </InputAdornment>
                                                ),
                                                endAdornment:(
                                    ...
                                    <Grid item className="w-full my-1">
                                        <TextField
                                            ...
                                            InputProps={{
                                                startAdornment:(
                                                    <InputAdornment postition="start">
                                                        <img src={smile} style={{maxWidth: inputIconSize, minHeight: inputIconSize}} alt="smile" />
                                                    </InputAdornment>
                                                ),
                                                endAdornment:(
                                    ...
                                    <Grid item className="w-full my-1 flex-col">
                                        <div className={`${(formik.touched.isAccepting && Boolean(formik.errors.isAccepting)) ? 'text-red-600' : 'text-current'} flex gap-3 items-center`}>
                                            <CheckBox color="primary" className="px-0" name="isAccepting" onChange={formik.handleChange} checked={formik.values.isAccepting} />
                                            <InputLabel style={{fontSize: 15}} className="text-black">I have read and accept Terms and Conditions</InputLabel>
                                        </div>
                    ...
                    <Grid item className="w-full">
                        <Grid container alignItems="center" direction="column" className="my-1" spacing={2}>
                            ...
                            <Grid item className="w-80 flex-col">
                                <div className={`${(formik.touched.isAccepting && Boolean(formik.errors.isAccepting)) ? 'text-red-600' : 'text-current'} flex gap-3 items-center`}>
                                    <CheckBox color="primary" className="px-0" name="isAccepting" onChange={formik.handleChange} checked={formik.values.isAccepting} />
                                    <InputLabel style={{fontSize: 13}} className="text-black">I have read and accept Terms and Conditions</InputLabel>
                                </div>
                                {formik.touched.isAccepting && Boolean(formik.errors.isAccepting) && <FormHelperText error className="ml-3">{formik.touched.hearAboutUs && formik.errors.isAccepting}</FormHelperText>}
                            </Grid>
                        </Grid>
